...
- **화면**: Cafe24 EC 관리자 모사. 흰 상단바(cafe24 로고 + 쇼핑몰명 `모든포장 (koreanhc7)` + 알림 벨), 좌측 다크 사이드바(주문 메뉴 활성), 메인 대시보드
- **레퍼런스**: 실존 쇼핑몰 https://koreanhc7.cafe24.com/ (포장재 제조·판매 B2B몰). 상품명/가격은 실제 판매 품목 기준, 주문 데이터는 전부 난수
...
- **카피**: 주문번호는 `20260706-0000123` 포맷. 구매자는 개인(김*진)과 사업자((주)달*식품, 카페 *뜰) 혼합 마스킹 — B2B몰의 리얼함. 새 문의 도착 시 벨 아래 미니 알림 ("커피봉투 로고 인쇄 되나요?" 류)
